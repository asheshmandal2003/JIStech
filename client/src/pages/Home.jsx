    ...
    return (
        <Container fluid className="p-0">
            <div className="hero-section bg-light text-center py-5">
                ...
                <p className="lead">Providing safety and security with real-time geolocation services and an SOS function for emergencies.</p>
            </div>
                ...
                <Col md={4}>
                    <Card className="h-100">
                        <Card.Body>
                            ...
                            <Card.Text>Share information with the community for collective safety.</Card.Text>
                        </Card.Body>
                    </Card>
                </Col>
            </Row>
